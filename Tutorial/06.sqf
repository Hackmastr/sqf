...
// supongo que sabréis cómo se quita la pantalla en negro (o en blanco), sobreescribiendo con un texto sin pantalla en negro xD
...
// y hasta que no quitéis el menú de pausa no ocurre nada.
