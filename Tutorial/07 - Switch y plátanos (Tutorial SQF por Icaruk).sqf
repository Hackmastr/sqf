...
switch (_miobjeto) do { // aquí, dependiendo del objeto que quiera comprar/vender _precio tendrá un valor u otro
...
if (_comprasOvendes) then { // true es para comprar
	...
	if (_miobjeto == "platano") then {platano = platano + 1}; // depende de cuál sea _miobjeto, cambiaré una variable u otra
