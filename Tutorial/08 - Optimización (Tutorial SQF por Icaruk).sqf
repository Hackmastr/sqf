...
lo de public por defecto está en false, pero si queremos que la variable sea públicae es decir, que todos los ordenadores
...
El mensaje de cuando compras y vendes, te tiene que informat del stock actual del ítem que has comprado/vendido.
