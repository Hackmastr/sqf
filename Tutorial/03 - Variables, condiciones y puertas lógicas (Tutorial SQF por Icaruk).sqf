...
// una condicion es una pregunta que al final será true o false, 0 o 1 en binario, abierta o cerrada en la puerta
...
if (num1 == 10) then {hint "Verdad"};
if (num1 != 9999) then {hint "Verdad"};
if (num1 => 10) then {hint "Verdad"};
if (num1 < 9999 10) then {hint "Verdad"};
